"""Generate blur/motion degradations (Gaussian blur + motion blur).

mild/medium = increasing Gaussian kernels; severe = horizontal motion blur.

Example:
    python src/synthetic/generate_blur_motion_degradation.py \
...
CONDITION = "blur_motion"


def main(argv=None):
    p = argparse.ArgumentParser(description="Generate blur/motion degradations.")
