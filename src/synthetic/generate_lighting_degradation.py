"""Generate lighting degradations (gamma darkening: mild/medium/severe).

Example:
    python src/synthetic/generate_lighting_degradation.py \
...
def main(argv=None):
    p = argparse.ArgumentParser(description="Generate lighting degradations.")
